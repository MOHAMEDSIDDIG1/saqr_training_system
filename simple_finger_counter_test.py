...
# -*- coding: utf-8 -*-
"""
نسخة مبسطة من finger_counter تعمل بشكل مستقل
...
class SimpleFingerCounter:
    ...
    def _run_counter(self):
        ...
        while self.running and cap.isOpened():
            ...
            # عرض الصورة
            cv2.imshow('Simple Finger Counter', img)
...
def test_simple_counter():
    """اختبار العد البسيط"""
    print("🧪 اختبار العد البسيط")
    print("=" * 40)
    
    counter = SimpleFingerCounter()
